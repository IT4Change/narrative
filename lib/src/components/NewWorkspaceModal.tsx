/**
 * NewWorkspaceModal - Dialog to create a new workspace with name and optional avatar
 *
 * Used across all Narrative apps to create new workspaces/documents.
 */
...
export interface NewWorkspaceModalProps {
  ...
  /** Custom title for the modal (default: "Neuer Workspace") */
  title?: string;
